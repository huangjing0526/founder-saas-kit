...
| **engineering/** `methodology/` | `anti-drift` (5 anti-drift principles, highest value) / `spec-driven-development` (SDD loop + spec↔code traceability) / `north-star-rules` / `common-pitfalls` / incident-ledger skeleton | Generic |
