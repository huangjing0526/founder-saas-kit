...
| **quality-scripts/** | [MECHANISMS](engineering/quality-scripts/MECHANISMS.md) · [harness](engineering/quality-scripts/harness.mjs) · [health-audit](engineering/quality-scripts/health-audit.cjs) · checks: [secrets](engineering/quality-scripts/check-secrets.cjs) · [docs-links](engineering/quality-scripts/check-docs-links.cjs) · [project-structure](engineering/quality-scripts/check-project-structure.js) · [i18n-parity](engineering/quality-scripts/check-i18n-parity.cjs) · [schema-text](engineering/quality-scripts/check-schema-text.cjs) · [migration-drift](engineering/quality-scripts/check-migration-drift.cjs) · [tenant-scope](engineering/quality-scripts/check-tenant-scope.cjs) · [spec-coverage](engineering/quality-scripts/check-spec-coverage.cjs) · [self-claims](engineering/quality-scripts/check-self-claims.cjs) · [map-index](engineering/quality-scripts/check-map-index.cjs) |
| **methodology/** | [anti-drift](engineering/methodology/anti-drift.md) · [spec-driven-development](engineering/methodology/spec-driven-development.md) · [distilling-from-real-projects](engineering/methodology/distilling-from-real-projects.md) · [north-star-rules](engineering/methodology/north-star-rules.md) · [common-pitfalls](engineering/methodology/common-pitfalls.md) · [pitfall-index template](engineering/methodology/pitfall-index.template.md) |
...
| **collaboration/** ([index](ops/collaboration/README.md)) | [ai-agent-roles](ops/collaboration/ai-agent-roles.md) · [unattended-handoff](ops/collaboration/unattended-handoff.md) · [onboarding](ops/collaboration/onboarding.md) · session-commands ([index](ops/collaboration/session-commands/README.md)): [save](ops/collaboration/session-commands/save-session.md) / [resume](ops/collaboration/session-commands/resume-session.md) / [clean](ops/collaboration/session-commands/clean-sessions.md) |
